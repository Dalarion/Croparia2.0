...
public class CollectorScreen extends ContainerScreen<CollectorContainer> {
	...
	private static final ResourceLocation COLLECTOR_GUI = new ResourceLocation(CropariaMod.mod_id,
			"textures/gui/collector.png");

	public CollectorScreen(CollectorContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int mouseX,
		...
		this.minecraft.textureManager.bindTexture(COLLECTOR_GUI);
